...
python decouple_eval/benchmark.py  --model resnet101 --preprocess cpu --max 5 --trt_instance_num 2 --timeout 5 --preprocess-instances 6 --total_number 1000000 --client 14 --save stability.log
...
python decouple_eval/benchmark.py  --model mobilenetv2_100 --preprocess cpu --max 6 --trt_instance_num 2 --timeout 5 --preprocess-instances 6 --total_number 1000000 --client 16 --save stability.log
...
python decouple_eval/benchmark.py  --model vit_base_patch16_siglip_224 --preprocess cpu --max 3 --trt_instance_num 2 --timeout 5 --preprocess-instances 6 --total_number 1000000 --client 10 --save stability.log
