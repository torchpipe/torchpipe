...
/usr/src/tensorrt/bin/trtexec --onnx=$onnx_path --saveEngine=./model_repository/resnet/resnet_trt/1/model.plan --explicitBatch --minShapes=input:1x3x224x224 --optShapes=input:8x3x224x224 --maxShapes=input:8x3x224x224 --fp16
