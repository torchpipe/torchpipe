...
void Select::post_init(const std::unordered_map<std::string, std::string>& config,
...
std::pair<size_t, size_t> Select::update_min_max(const std::vector<Backend*>& depends) {
  // union
  size_t max_value = 1;
