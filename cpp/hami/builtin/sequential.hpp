...
namespace hami
{
     ...
     *
     * This class sequentially calls sub-backends and performs a swap operation during the calls.
     */
    ...
    private:
         ...
         *
         * This method initializes the sub-backends in reverse order. The names of the sub-backends are specified using the `SequentialV0::dependency` parameter, which supports multiple backends separated by commas. It also supports an or prefix filter.
         *
         * @param params A map of parameters for initialization.
         * @param options A dictionary of options.
         */
        virtual void impl_custom_init(const std::unordered_map<std::string, std::string> &params,
                                      const dict &options) override;

        /**
         * @brief SequentialV0ly calls sub-backends.
         *
         * @param io A vector of input/output dictionaries for each sub-backend call.
         */
