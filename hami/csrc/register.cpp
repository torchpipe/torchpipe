...
namespace hami
{
    ...
    HAMI_ADD_HASH(std::pair<std::unordered_map<std::string, std::string>, std::string>)([](const any &data)
                                                                                        { 
                                                                                            const auto *target = any_cast<std::pair<std::unordered_map<std::string, std::string>, std::string>>(&data);
                                                                                            py::list result;
                                                                                            result.append(py::cast(target->first));
                                                                                            result.append(py::cast(target->second));
                                                                                            return result; });
    HAMI_ADD_HASH(std::pair<std::string, std::unordered_map<std::string, std::string>>)([](const any &data)
                                                                                        { 
                                                                                            const auto *target = any_cast<std::pair<std::string, std::unordered_map<std::string, std::string>>>(&data);
                                                                                            py::list result;
                                                                                            result.append(py::cast(target->first));
                                                                                            result.append(py::cast(target->second));
                                                                                            return result; });
