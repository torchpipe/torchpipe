...
py::object PyDict::pop(const std::string& key, std::optional<std::string> default_value) {
...
void PyDict::set(const std::string& key, const py::object& value) {
  ...
  if (data == std::nullopt) throw py::type_error("The input type is unknown by hami.any.");
...
void init_dict(py::module_& m) {
  ...
  hami_dict.def(py::init<>())
      .def(py::init<const py::dict&>(), "Construct a dictionary from a Python dict")
      // .def("set", &PyDict::set, "Set a value in the dictionary", "key"_a, "value"_a)
      .def("get", &PyDict::get, "Get a value from the dictionary", "key"_a)
      .def("contains", &PyDict::contains, "Check if the dictionary contains a key", "key"_a)
      .def("remove", &PyDict::remove, "Remove a key from the dictionary", "key"_a)
      .def("clear", &PyDict::clear, "Clear the dictionary")
      .def("pop", &PyDict::pop, py::arg("key"), py::arg("default") = py::none(),
           "Remove specified key and return the corresponding value.\n"
           "If key is not found, default is returned if given, otherwise KeyError is raised.")
      .def("__setitem__", py::overload_cast<const std::string&, const py::object&>(&PyDict::set),
           "Set a value in the dictionary", "key"_a, "value"_a)
      .def("__setitem__",
           py::overload_cast<const std::string&,
                             const std::unordered_map<std::string, std::string>&>(&PyDict::set),
           "Set a nested dictionary value in the dictionary", "key"_a, "value"_a)
      .def("__getitem__", &PyDict::get, "Get a value from the dictionary", "key"_a)
      ...
      .def("__contains__", &PyDict::contains, "Check if the dictionary contains a key", "key"_a)
      .def("__delitem__", &PyDict::remove, "Remove a key from the dictionary", "key"_a)
      .def("__len__", &PyDict::size, "Get the number of items in the dictionary")
