...
constexpr auto UNKNOWN_PYTHON_TYPE =
    ...
    "have used "
    "`register_py2cpp(std::function<std::optional<hami::any>(const "
    "pybind11::handle&))` to "
...
// void register_py2cpp(std::function < std::optional<hami::any>(const
// pybind11::handle&));
