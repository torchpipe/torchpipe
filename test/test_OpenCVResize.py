...
class TestOpenCVResize:
    ...
    # def test_OpenCVResizeTensor(self, target_h,target_w, src_array):
    ...
    #                                              "save_dir": "./",
    #                                              'backend': "Sequential[OpenCVResizeTensor, SyncTensor]"}})
    #     pipe_tensor(imnpoit)
...
if __name__ == "__main__":
    ...
    if True:
        a.test_OpenCVResizeTensor(2, 2, a.src_arrays[0])
    else:
