...
class BatchfulAttention(OPTAttention):
    """Multi-headed attention from 'Attention Is All You Need' paper"""
...
#     "export": BatchfulAttention
# }
OPT_ATTENTION_CLASSES = {
    "eager": BatchfulAttention,
}
