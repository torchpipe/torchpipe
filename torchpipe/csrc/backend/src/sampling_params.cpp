// adapted from
// https://github.com/vectorch-ai/ScaleLLM/blob/dd712028cc418444fc055fc0984b01f313f60092/scalellm/csrc/sampling_params.cpp
...
void init_sampling_params(py::module_& m) {
  ...
  py::class_<SamplingParams>(m, "SamplingParams")
      .def(py::init<uint32_t,                                /*max_tokens*/
           ...
           py::arg("max_tokens") = 16, py::arg("n") = 1, py::arg("best_of") = std::nullopt,
           py::arg("echo") = false, py::arg("frequency_penalty") = 0.0,
           py::arg("presence_penalty") = 0.0, py::arg("repetition_penalty") = 1.0,
           py::arg("temperature") = 1.0, py::arg("top_p") = 1.0, py::arg("top_k") = -1,
           py::arg("logprobs") = false, py::arg("top_logprobs") = 0,
           py::arg("skip_special_tokens") = true, py::arg("ignore_eos") = false,
           py::arg("stop") = std::nullopt, py::arg("stop_token_ids") = std::nullopt)
      ...
      .def("__repr__", [](const SamplingParams& self) {
        return "SamplingParams(max_tokens={}, n={}, best_of={}, echo={}, "
               ...
               "ignore_eos={}, stop={}, stop_token_ids={})"_s.format(
                   self.max_tokens, self.n, self.best_of, self.echo, self.frequency_penalty,
                   self.presence_penalty, self.repetition_penalty, self.temperature, self.top_p,
                   self.top_k, self.logprobs, self.top_logprobs, self.skip_special_tokens,
                   self.ignore_eos, self.stop, self.stop_token_ids);
      });
}
