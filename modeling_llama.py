        ...
        **kwargs: Unpack[FlashAttentionKwargs],
        ...
        if True:
            ...
            if q_len == 1:
                ...
                attn_output = flashinfer.single_prefill_with_kv_cache(q, 
                                                                      key_states[0], value_states[0], causal=True,kv_layout="HND")
                attn_output = attn_output.view(bsz, q_len, -1)
            attn_weights =None
...
class LlamaForCausalLM(LlamaPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **kwargs: Unpack[KwargsForCausalLM],
        ...
        >>> # Generate
        >>> generate_ids = model.generate(inputs.input_ids, context_length=30)
